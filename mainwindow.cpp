...
void MainWindow::updateList()
{
    ...
    for (auto el: this->categoriesName){
        ...
        for (auto& els2: products){
            if(els2.getCategory()==ui->addProduct_category->currentText()){
                ui->addProduct_name->addItem(els2.getName());
                ui->removeProduct_name->addItem(els2.getName());
                ui->filter_name->addItem(els2.getName());
            }
        }
